...
type Config struct {
	...
	AUTH_POSTGRES_BILL_SPLIT_READ_WRITE string        `mapstructure:"AUTH_POSTGRES_BILL_SPLIT_READ_WRITE"`
...
func bindEnvironmentVariables() {
	...
	viper.BindEnv("AUTH_POSTGRES_BILL_SPLIT_READ_WRITE")
...
func maskSensitiveInfo(config Config) Config {
	...
	if config.AUTH_POSTGRES_BILL_SPLIT_READ_WRITE != "" {
		maskedConfig.AUTH_POSTGRES_BILL_SPLIT_READ_WRITE = "[REDACTED]"
	}
